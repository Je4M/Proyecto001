...
<div class="container">
    <div class="row m-5 no-gutters shadow-lg">
        <div class="col-md-4 d-none d-md-block">
            <img src="fandfur1.png" class="img-fluid" style="min-height:80%;" />
        </div>
        <div class="col-md-6 bg-white p-5">
            ...
            <div>
                <form action="iniciar_sesion.php" method="post">
                    ...
                    <div class="pb-2">
                        <button type="submit" name="ingresar" class="btn btn-primary w-100 font-weight-bold mt-2">Ingresar ga git ga  </button>
                    </div>
                </form>
             </div>
        </div>
